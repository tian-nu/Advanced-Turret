...
public class ModItems {
    ...
    public static final RegistryObject<Item> SOLAR_PLUGIN =
            ITEMS.register("solar_plugin", () -> new Item(new Item.Properties().stacksTo(64)));
    public static final RegistryObject<Item> AMMO_RECYCLING_PLUGIN =
            ITEMS.register("ammo_recycling_plugin", () -> new Item(new Item.Properties().stacksTo(64)));
    public static final RegistryObject<Item> REDSTONE_CONVERSION_PLUGIN =
            ITEMS.register("redstone_conversion_plugin", () -> new Item(new Item.Properties().stacksTo(64)));
    public static final RegistryObject<Item> DESTRUCTION_PLUGIN =
            ITEMS.register("destruction_plugin", () -> new Item(new Item.Properties().stacksTo(64)));
    ...
    public static final RegistryObject<Item> ATTACK_BOOST_COMPONENT =
            ITEMS.register("attack_boost_component", () -> new Item(new Item.Properties().stacksTo(64)));
    public static final RegistryObject<Item> ENERGY_EFFICIENCY_COMPONENT =
            ITEMS.register("energy_efficiency_component", () -> new Item(new Item.Properties().stacksTo(64)));
    public static final RegistryObject<Item> RANGE_COMPONENT =
            ITEMS.register("range_component", () -> new Item(new Item.Properties().stacksTo(64)));
    public static final RegistryObject<Item> ACCURACY_COMPONENT =
            ITEMS.register("accuracy_component", () -> new Item(new Item.Properties().stacksTo(64)));
    public static final RegistryObject<Item> FIRE_RATE_COMPONENT =
            ITEMS.register("fire_rate_component", () -> new Item(new Item.Properties().stacksTo(64)));
