...
public class ModBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<PhaseFieldTurretBlockEntity>> PHASE_FIELD_TURRET =
            BLOCK_ENTITIES.register("phase_field_turret", () ->
                    BlockEntityType.Builder.of(PhaseFieldTurretBlockEntity::new,
                            ModBlocks.PHASE_FIELD_TURRET.get()
                    ).build(null));
    public static final RegistryObject<BlockEntityType<ResonanceFieldTurretBlockEntity>> RESONANCE_FIELD_TURRET =
            BLOCK_ENTITIES.register("resonance_field_turret", () ->
                    BlockEntityType.Builder.of(ResonanceFieldTurretBlockEntity::new,
                            ModBlocks.RESONANCE_FIELD_TURRET.get()
                    ).build(null));
