 ...
 */
public class MachineGunTurretGeoRenderer extends GeoBlockRenderer<MachineGunTurretBlockEntity> {

    public MachineGunTurretGeoRenderer(BlockEntityRendererProvider.Context context) {
        super(new MachineGunTurretGeoModel());
    }
